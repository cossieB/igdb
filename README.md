...
## API Key
The endpoints require a valid x-api-key header. Use ```uk_QOFDUChUqBhrAvaxVLNZudHsoZunRxlPAaArZUeTyktQIibZlGEHbmyemOwHYCNg```.  If that key is rate limited you can generate your own at https://igdb.cossie.workers.dev/ after signing up with your Google or Github account.